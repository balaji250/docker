...
class AddSubtask {
    ...
    addSubtask(taskboardData) {
        ...
        subTaskName.type(taskboardData.SubTaskName)
        ...
        //Open Subtask
        const openSubtask = cy.get('.cdk-drag-disabled > #openTask > .mat-card-content');
        openSubtask.click();
        ...
        enterDescription.type(taskboardData.SubTaskDescription);
        ...
        const clickFlagIcon = cy.get('.flag-css');
        clickFlagIcon.click();
        ...
        labelName.type(taskboardData.SubTaskLabelName);
        ...
        cy.get('#labelButton_0 > .row > .col-md-10').contains('Bug').click();
