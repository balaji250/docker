...
class EditProjectConfiguration {
    ...
    editprojectconfiguration(projectdata) {
        ...
        taskboardDescription.type(projectdata.EditTaskboardDescription);
        ...
        renameStatusName.type(projectdata.RenameColumnName);
        ...
        sprintDuration.type(projectdata.SprintDuration)
...
export default EditProjectConfiguration;